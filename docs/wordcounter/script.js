...
function updateStats() {
    var paper = document.querySelector("#paperlookinthing");
    ...
    words.innerHTML = paper.value.split(/\s+/g).filter(function (it) {
        return !!it.replace(/\W/g, "").toString();
    }).length;
