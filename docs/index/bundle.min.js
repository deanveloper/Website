...
"use strict";function _classCallCheck(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}function animateHover(e){}var _createClass=function(){function e(e,n){for(var t=0;t<n.length;t++){var a=n[t];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(n,t,a){return t&&e(n.prototype,t),a&&e(n,a),n}}(),anime=require("animejs"),$=require("jquery"),icons={};$(document).ready(function(){icons.github=new Icon("code"),icons.donate=new Icon("dollar"),icons.twitter=new Icon("twitter"),icons.contact=new Icon("address-card-o"),icons.blog=new Icon("file-text-o"),icons.tools=new Icon("wrench")});var Icon=function(){function e(n){_classCallCheck(this,e),$("#items").append($("<li>").append($("<div>").attr("id",n).attr("class","icon").append($("<i>").attr("class","fa fa-2x fa-"+n)))),this.elem=$("#"+n)}return _createClass(e,[{key:"onClick",value:function(){anime({targets:this.elem,rotate:180,duration:300,easing:"easeOut",loop:!1})}}]),e}();
