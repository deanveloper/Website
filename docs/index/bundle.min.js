...
"use strict";function _classCallCheck(o,n){if(!(o instanceof n))throw new TypeError("Cannot call a class as a function")}function animateHover(o){}var $=require("jquery"),icons={};$(document).ready(function(){icons.github=new Icon("github-alt",1,"https://github.com/Deanveloper","GitHub"),icons.twitter=new Icon("twitter",1,"https://twitter.com/Deanveloper","Twitter"),icons.donate=new Icon("dollar",1,"https://paypal.me/Dean98","Donate"),icons.email=new Icon("address-card-o",2,"mailto:dean@deanveloper.com","Email"),icons.blog=new Icon("file-text-o",2,"https://blog.deanveloper.com","Blog [Coming Soon]"),icons.tools=new Icon("wrench",2,"https://www.deanveloper.com/tools","Tools [Coming Soon]")});var Icon=function o(n,t,e,a){_classCallCheck(this,o),$("#items"+t).append($("<li>").append($("<div>").attr("id",n).attr("class","icon").append($("<i>").attr("class","fa fa-2x fa-"+n))).append($("<span>").attr("class","tooltip").append(a))),this.$elem=$("#"+n),this.$elem.mouseup(function(){a.endsWith("[Coming Soon]")||(window.location.href=e)})};
