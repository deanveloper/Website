...
function drawExports() {
    ...
    var save = {
        ...
        span: (0, _script.$)("<span class='icon fa fa-2x fa-floppy-o'>"),
        tooltip: (0, _script.$)("<span class='tooltip above'>").html("Save")
    };
    var share = {
        container: (0, _script.$)("<div class='container'>"),
        label: (0, _script.$)("<label class='item' id='sharelbl'>"),
        span: (0, _script.$)("<span class='icon fa fa-2x fa-share-square-o'>"),
...
function flattened() {
    ...
    try {
        for (var _iterator = canvasStack[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var can = _step.value;
        ...
        value: function mouseup(e, canvas) {
            ...
            for (var startX = start.x; startX < start.x + change.x; startX += 10) {
                for (var startY = start.y; startY < start.y + change.y; startY += 10) {
                    ...
                    var regionX = startX - start.x;
                    var regionY = startY - start.y;
                    ...
                    for (var x = 0; x < width; x++) {
                        for (var y = 0; y < height; y++) {
                            var index = 4 * ((regionY + y) * change.x + (regionX + x));
