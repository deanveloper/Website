    ...
    _createClass(Move, [{
        ...
        value: function use() {
            ...
            if (this !== Moves.NOTHING) {
                (0, _script.pokeMessage)("You used " + this.name + "!", function () {
                    _this.playAnimation();
...
var Teleport = function (_Move2) {
    ...
    _createClass(Teleport, [{
        ...
        key: "onUse",
        value: function onUse() {
            (0, _script.pokeMessage)("You teleported to the main page!", function () {
                window.setTimeout(_script.redirToMain, 2000);
            });
        }
    }]);
...
var Slash = function (_Move3) {
    ...
    _createClass(Slash, [{
        ...
        key: "use",
        value: function use() {
            (0, _script.pokeMessage)("You used Slash!", function () {});
        }
    }]);
...
window.addEventListener("load", function () {
    ...
    pokeMessage("A wild 404 appeared!", function () {
        return mainMenu("FIGHT", "PKMN", "BAG", "RUN");
    });
