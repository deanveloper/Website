...
var PokemonEnum = exports.PokemonEnum = {
    FRIENDLY: new Pokemon("Gallade", [_Move.Moves.TELEPORT, _Move.Moves.NOTHING, _Move.Moves.NOTHING, _Move.Moves.NOTHING]),
    ...
    _createClass(Slash, [{
        ...
        value: function use() {
            ...
            (0, _script.pokeMessage)(msg, function () {
                return (Math.random() < .75 ? Moves.FILE : Moves.REDIRECT).use(_Pokemon.PokemonEnum.ENEMY);
            });
        }
    }]);
...
var File = function (_Move4) {
    ...
    function File() {
        ...
        var _this5 = _possibleConstructorReturn(this, (File.__proto__ || Object.getPrototypeOf(File)).call(this, "File"));
        ...
        value: function use() {
            switch (this.counter) {
                ...
                case 1:
                    ...
                    break;
                default:
                    (0, _script.pokeMessage)("The pokemon is corrupt! Redirecting to main page...", _script.redirToMain);
                    break;
            }
...
window.addEventListener("load", function () {
    ...
    var _arr2 = ["#friendlyPlatform", "#enemyPlatform"];
    for (var _i2 = 0; _i2 < _arr2.length; _i2++) {
        var id = _arr2[_i2];
        var _elem = document.querySelector(id);
        var ctx = _elem.getContext("2d");
        ctx.beginPath();
        ctx.arc(_elem.width / 2, _elem.height / 2, _elem.height / 2, 0, 2 * Math.PI);
        ctx.scale(_elem.width / _elem.height, 1);
        ctx.stroke();
    }
});
...
function mouseClicked(data) {
    var string = data.innerHTML.substring(1);
    switch (string) {
        case "FIGHT":
            ...
            break;
        case "PKMN":
            pokeMessage("This is your only pokemon!", function () {});
            break;
        case "BAG":
