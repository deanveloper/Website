...
"use strict";function update(){var t=moment(),e=t.diff(targetDate,"months");t.subtract(e,"months");var n=t.diff(targetDate,"weeks");t.subtract(n,"weeks");var a=t.diff(targetDate,"days");t.subtract(a,"days");var r=t.diff(targetDate,"hours");t.subtract(r,"hours");var o=t.diff(targetDate,"minutes");t.subtract(o,"minutes");var d=t.diff(targetDate,"seconds");t.subtract(d,"seconds"),document.getElementById("months").innerHTML=Math.abs(e).toString(),document.getElementById("weeks").innerHTML=Math.abs(n).toString(),document.getElementById("days").innerHTML=Math.abs(a).toString(),document.getElementById("hours").innerHTML=Math.abs(r).toString(),document.getElementById("minutes").innerHTML=Math.abs(o).toString(),document.getElementById("seconds").innerHTML=Math.abs(d).toString()}var moment=require("moment"),targetDate=moment("12-30-2016","MM-DD-YYYY");window.addEventListener("load",function(){update(),setInterval(update,100),document.querySelector("#date").innerHTML=targetDate.format("dddd, MMMM Do YYYY")}),document.ontouchstart=function(t){t.preventDefault()},document.ontouchmove=function(t){t.preventDefault()};
